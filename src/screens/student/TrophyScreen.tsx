...
import { useTrophyColors, getTypeColor, getTypeLabel, getTypeEmoji } from "../../hooks/useTrophyColors";
      ...
      >
        ...
        <Animated.View style={{
          ...
          {sections.map((section) => {
            const sectionUnlocked = section.items.filter((a) => a.unlocked).length;
